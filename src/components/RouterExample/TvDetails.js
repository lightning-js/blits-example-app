  ...
  template: `
    <Element w="1920" h="1080" color="#1e293b">
      ...
      <Element x="402" w="1518">
        <Text content="TV Show Details" x="40" y="50" size="42" font="raleway" color="#fff" />
        <Element x="40" y="140" w="1400" h="780" color="#374151" :effects="[{type: 'radius', props: 12}]">
          ...
          <!-- Seasons List -->
          <Element x="40" y="370" w="1200">
            <Text content="Seasons:" size="24" color="#fff" />
            <Element w="1200" h="350" clipping="true" y="40">
              <SeasonItem
